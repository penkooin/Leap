...
public class AnnotationHelper {
    ...
    public static Map<String, Method> getServiceMethodMap(ServiceModel service) throws HTTPException {
        ...
        ServiceIndicates serviceIndicator = service.getClass().getDeclaredAnnotation(ServiceIndicates.class);
        if(serviceIndicator != null) {
            String sPath = serviceIndicator.path();
            if(sPath == null) {
            ...
            for(Method method : methods) {
                MethodIndicates methodIndicator = method.getDeclaredAnnotation(MethodIndicates.class);
                if(methodIndicator != null) {
                    String mPath = methodIndicator.path();
                    if(mPath == null) {
